    ...
    public class SanPham
    {
        ...
        public List<SqlParameter> GetParameters()
        {
            List<SqlParameter> list = new List<SqlParameter>
            {
                ...
                new SqlParameter("@maLoaiSP", loaiSP.maLoaiSP),
                new SqlParameter("@ten", ten),
                new SqlParameter("@gia", gia),
                new SqlParameter("@soLuong", soLuong),
                new SqlParameter("@luocBan", luocBan),
                new SqlParameter("@tacGia", tacGia),
                new SqlParameter("@dichGia", dichGia),
                new SqlParameter("@ngonNgu", ngonNgu),
                new SqlParameter("@soTrang", soTrang),
                new SqlParameter("@nhaXuatBan", nhaXuatBan),
                new SqlParameter("@namXuatBan", namXuatBan),
                new SqlParameter("@loaiBia", loaiBia),
